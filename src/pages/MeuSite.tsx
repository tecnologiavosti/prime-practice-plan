...
const DEFAULTS = {
  ...
  especialidades: [
    { slug: 'psicologia', icon: 'Brain', title: 'Psicologia', desc: 'Acompanhamento psicoterapêutico individual para adultos, adolescentes e crianças.', subtitle: 'Cuidado emocional contínuo para todas as fases da vida', intro: 'Atendimento psicoterapêutico individual para crianças, adolescentes, adultos e idosos. Trabalhamos ansiedade, depressão, autoestima, relacionamentos e desenvolvimento pessoal com abordagens baseadas em evidências.', benefits: 'Acolhimento humanizado e sigiloso\nAtendimento presencial e online\nAbordagens TCC, psicanálise e humanista\nAcompanhamento contínuo personalizado', indications: 'Ansiedade e crises de pânico\nDepressão e tristeza persistente\nEstresse, burnout e sobrecarga\nConflitos familiares e relacionais\nLuto e fases de transição', long: '' },
    { slug: 'psiquiatria', icon: 'Stethoscope', title: 'Psiquiatria', desc: 'Avaliação e tratamento medicamentoso para depressão, ansiedade, TDAH e outros transtornos.', subtitle: 'Tratamento médico especializado em saúde mental', intro: 'Avaliação clínica completa e acompanhamento medicamentoso quando necessário, sempre integrado ao processo psicoterapêutico para resultados mais consistentes.', benefits: 'Diagnóstico preciso e individualizado\nPrescrição responsável e segura\nIntegração com a psicoterapia\nReavaliações periódicas', indications: 'Transtornos de ansiedade\nDepressão moderada e grave\nTDAH em adultos e crianças\nTranstorno bipolar\nInsônia e distúrbios do sono', long: '' },
    { slug: 'nutricao', icon: 'Apple', title: 'Nutrição', desc: 'Nutrição comportamental integrada à saúde mental e qualidade de vida.', subtitle: 'Nutrição comportamental integrada à saúde mental', intro: 'Plano alimentar individualizado considerando rotina, preferências e saúde emocional. Foco em qualidade de vida, não em dietas restritivas.', benefits: 'Plano alimentar personalizado\nEducação alimentar duradoura\nIntegração com saúde mental\nAcompanhamento de evolução', indications: 'Reeducação alimentar\nCompulsão alimentar\nEmagrecimento saudável\nNutrição clínica\nPerformance e bem-estar', long: '' },
    { slug: 'fonoaudiologia', icon: 'MessageSquare', title: 'Fonoaudiologia', desc: 'Diagnóstico e terapia para linguagem, fala, voz e desenvolvimento infantil.', subtitle: 'Comunicação, linguagem e desenvolvimento infantil', intro: 'Avaliação e terapia para linguagem, fala, voz e desenvolvimento da comunicação, com foco em resultados práticos no dia a dia.', benefits: 'Avaliação detalhada e diagnóstica\nPlano terapêutico individualizado\nOrientação para família e escola\nSessões lúdicas para crianças', indications: 'Atraso de linguagem infantil\nTrocas e dificuldades de fala\nGagueira\nAlterações de voz\nApoio a TEA e TDAH', long: '' },
    { slug: 'rn1', icon: 'Briefcase', title: 'RN-1', desc: 'Cuidado completo para colaboradores com acesso à Psiquiatria, Psicologia, Nutrição e Personal Trainer, além de atendimento médico 24h e teleconsultas.', subtitle: 'Plano corporativo de saúde mental e bem-estar', intro: 'Cuidado completo para colaboradores com acesso à Psiquiatria, Psicologia, Nutrição e Personal Trainer, além de atendimento médico 24h e teleconsultas. Mais saúde, bem-estar e produtividade para sua equipe.', benefits: 'Psiquiatria — acompanhamento especializado\nPsicologia mensal para equilíbrio mental\nNutrição mensal personalizada\nPersonal Trainer mensal para qualidade de vida', indications: 'Empresas que buscam reduzir afastamentos\nValorização e retenção da equipe\nDiferencial competitivo no mercado\nBenefício com alto valor percebido', long: '' },
    { slug: 'avaliacao-neuropsicologica', icon: 'ClipboardList', title: 'Avaliação Neuropsicológica', desc: 'Investigação aprofundada das funções cognitivas — memória, atenção, linguagem e funções executivas — com laudo completo.', subtitle: 'Mapeamento aprofundado das funções cognitivas', intro: 'Bateria completa de testes padronizados para avaliar memória, atenção, linguagem, raciocínio e funções executivas. Emitimos laudo detalhado com orientações para tratamento, escola e trabalho.', benefits: 'Laudo técnico completo e detalhado\nTestes padronizados internacionalmente\nOrientação para escola, família e trabalho\nIntegração com psicologia e psiquiatria', indications: 'Suspeita de TDAH em crianças e adultos\nInvestigação de dificuldades de aprendizagem\nAvaliação de TEA (Transtorno do Espectro Autista)\nDiagnóstico diferencial em quadros complexos\nAvaliação de demências e declínio cognitivo', long: '' },
    { slug: 'clinico-medico', icon: 'Cross', title: 'Clínico Médico', desc: 'Consulta médica ampla com avaliação clínica, exames, acompanhamento de doenças crônicas e cuidado preventivo.', subtitle: 'Cuidado médico integral para toda a família', intro: 'Consulta clínica ampla com anamnese detalhada, exame físico, solicitação e análise de exames, além de acompanhamento de doenças crônicas e cuidado preventivo em todas as fases da vida.', benefits: 'Avaliação médica completa\nCoordenação com outras especialidades\nRenovação e ajuste de medicações\nFoco em prevenção e qualidade de vida', indications: 'Check-up periódico\nHipertensão, diabetes e colesterol\nAvaliação pré-operatória\nSintomas gerais sem diagnóstico definido\nAcompanhamento de doenças crônicas', long: '' },
    { slug: 'psicopedagogia', icon: 'BookOpen', title: 'Psicopedagogia', desc: 'Avaliação e intervenção para dificuldades de aprendizagem, TDAH e organização de estudos.', subtitle: 'Aprender com autonomia, confiança e prazer', intro: 'Avaliação e intervenção psicopedagógica para crianças, adolescentes e adultos com dificuldades de aprendizagem, foco, organização de estudos e desempenho escolar.', benefits: 'Diagnóstico psicopedagógico completo\nIntervenção lúdica e personalizada\nOrientação a pais e escolas\nEstratégias práticas de estudo', indications: 'Dificuldades de leitura e escrita\nBaixo rendimento escolar\nTDAH e problemas de atenção\nDislexia, discalculia e disgrafia\nAnsiedade em provas e concursos', long: '' },
    { slug: 'neurologia', icon: 'Activity', title: 'Neurologia', desc: 'Diagnóstico e tratamento de doenças do sistema nervoso: cefaleias, epilepsia, distúrbios do sono e neurodegenerativas.', subtitle: 'Cuidado especializado para o sistema nervoso', intro: 'Diagnóstico e tratamento de doenças neurológicas com abordagem baseada em evidências, incluindo cefaleias, epilepsia, distúrbios do sono, tonturas e doenças neurodegenerativas.', benefits: 'Avaliação neurológica detalhada\nSolicitação e leitura de exames especializados\nTratamento medicamentoso individualizado\nAcompanhamento contínuo de longo prazo', indications: 'Enxaquecas e cefaleias crônicas\nEpilepsia e crises convulsivas\nTonturas, vertigens e desequilíbrios\nInsônia e distúrbios do sono\nDoenças neurodegenerativas (Alzheimer, Parkinson)', long: '' },
