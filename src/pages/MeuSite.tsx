...
const DEFAULTS = {
  ...
  especialidades: [
    ...
    { slug: 'rn1', icon: 'Briefcase', title: 'RN-1', desc: 'Cuidado completo para colaboradores com acesso a Psiquiatria, Psicologia, Nutrição e Personal Trainer.', subtitle: 'Plano corporativo de saúde mental e bem-estar', intro: 'Cuidado completo para colaboradores com atendimento médico 24h e teleconsultas.', benefits: '', indications: '', long: '' },
    { slug: 'avaliacao-neuropsicologica', icon: 'ClipboardList', title: 'Avaliação Neuropsicológica', desc: 'Investigação aprofundada das funções cognitivas — memória, atenção, linguagem e funções executivas — com laudo completo.', subtitle: 'Mapeamento aprofundado das funções cognitivas', intro: 'Bateria completa de testes padronizados para avaliar memória, atenção, linguagem e funções executivas, com laudo detalhado e orientações.', benefits: 'Laudo técnico completo e detalhado\nTestes padronizados internacionalmente\nOrientação para escola, família e trabalho\nIntegração com psicologia e psiquiatria', indications: 'Suspeita de TDAH em crianças e adultos\nDificuldades de aprendizagem\nAvaliação de TEA\nDiagnóstico diferencial em quadros complexos\nDemências e declínio cognitivo', long: '' },
    { slug: 'clinico-medico', icon: 'Cross', title: 'Clínico Médico', desc: 'Consulta médica ampla com avaliação clínica, exames, acompanhamento de doenças crônicas e cuidado preventivo.', subtitle: 'Cuidado médico integral para toda a família', intro: 'Consulta clínica com anamnese detalhada, exame físico, solicitação e análise de exames e acompanhamento de doenças crônicas.', benefits: 'Avaliação médica completa\nCoordenação com outras especialidades\nRenovação e ajuste de medicações\nFoco em prevenção e qualidade de vida', indications: 'Check-up periódico\nHipertensão, diabetes e colesterol\nAvaliação pré-operatória\nSintomas gerais sem diagnóstico definido\nDoenças crônicas', long: '' },
    { slug: 'psicopedagogia', icon: 'BookOpen', title: 'Psicopedagogia', desc: 'Avaliação e intervenção para dificuldades de aprendizagem, TDAH e organização de estudos.', subtitle: 'Aprender com autonomia, confiança e prazer', intro: 'Avaliação e intervenção psicopedagógica para crianças, adolescentes e adultos com dificuldades de aprendizagem e desempenho escolar.', benefits: 'Diagnóstico psicopedagógico completo\nIntervenção lúdica e personalizada\nOrientação a pais e escolas\nEstratégias práticas de estudo', indications: 'Dificuldades de leitura e escrita\nBaixo rendimento escolar\nTDAH e problemas de atenção\nDislexia, discalculia e disgrafia\nAnsiedade em provas e concursos', long: '' },
    { slug: 'neurologia', icon: 'Activity', title: 'Neurologia', desc: 'Diagnóstico e tratamento de doenças do sistema nervoso: cefaleias, epilepsia, distúrbios do sono e neurodegenerativas.', subtitle: 'Cuidado especializado para o sistema nervoso', intro: 'Diagnóstico e tratamento de doenças neurológicas com abordagem baseada em evidências.', benefits: 'Avaliação neurológica detalhada\nExames especializados\nTratamento individualizado\nAcompanhamento contínuo', indications: 'Enxaquecas e cefaleias crônicas\nEpilepsia e crises convulsivas\nTonturas e vertigens\nInsônia e distúrbios do sono\nAlzheimer e Parkinson', long: '' },
